  ...
  return (
    <div className="bg-brand-light py-20">
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-6xl mx-auto bg-white p-8 md:p-12 rounded-lg shadow-lg grid md:grid-cols-2 gap-12">
          {/* Contact Info */}
          <div className="space-y-8 flex flex-col justify-center">
            ...
            <ContactInfoItem
              ...
              title="Email"
            >
              <a href="mailto:marketing@daneshindustries.com" className="hover:text-brand-blue">marketing@daneshindustries.com</a>
              <br />
              <a href="mailto:daneshindustries@gmail.com" className="hover:text-brand-blue">daneshindustries@gmail.com</a>
            </ContactInfoItem>
            ...
            <ContactInfoItem
              ...
              title="Phone"
            >
              <p>Praveen Kumar M: <a href="tel:+918939415026" className="hover:text-brand-blue">+91 8939 415026</a> / <a href="tel:+919962333220" className="hover:text-brand-blue">+91 99623 33220</a></p>
              <p>Arivudainambi D: <a href="tel:+919500071287" className="hover:text-brand-blue">+91 95000 71287</a> / <a href="tel:+919884001473" className="hover:text-brand-blue">+91 98840 01473</a></p>
            </ContactInfoItem>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <textarea name="message" id="message" rows={4} required value={formData.message} onChange={handleChange} className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand-blue focus:border-brand-blue"></textarea>
              </div>
              <div>
                <button type="submit" className="w-full flex justify-center py-3 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-brand-blue hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-brand-blue transition-colors">
                  Send Message
                </button>
              </div>
            </form>
