    ...
    <div className="bg-brand-light py-20">
      <div className="container mx-auto px-6 max-w-4xl bg-white p-10 rounded-lg shadow-md">
        ...
        <div className="prose lg:prose-xl max-w-none text-brand-dark space-y-6">
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">1. Information We Collect</h2>
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">2. How We Use Your Information</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">3. Data Sharing & Disclosure</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">4. Data Security</h2>
            <p>We implement safeguards to protect data against unauthorized access.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">5. Cookies & Tracking</h2>
            <p>Our site may use cookies to improve user experience.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">6. Data Retention</h2>
            <p>We retain data only as long as required for business or legal compliance.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">7. Your Rights</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">8. Third-Party Links</h2>
            <p>We are not responsible for privacy practices of third-party sites.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">9. Updates</h2>
            <p>This policy may be updated periodically.</p>
          </section>
          <section>
            <h2 className="text-2xl font-bold text-brand-blue">10. Contact Us</h2>
            <p>
